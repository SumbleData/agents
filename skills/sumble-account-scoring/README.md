...
```bash
npx skills add SumbleData/agents --skill sumble-account-scoring -g -a codex -y
...
1. Download this repo as a ZIP:
   [github.com/SumbleData/agents → Code → Download ZIP](https://github.com/SumbleData/agents/archive/refs/heads/main.zip),
   then unzip it.

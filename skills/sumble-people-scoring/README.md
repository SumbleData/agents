...
```bash
npx skills add SumbleData/agents --skill people-scoring
```

To install globally for a specific agent without prompts:

```bash
npx skills add SumbleData/agents --skill people-scoring -g -a codex -y
npx skills add SumbleData/agents --skill people-scoring -g -a claude-code -y
```
